  ...
  return (
    <div className="min-h-screen bg-gray-950 relative overflow-hidden">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-0 left-1/4 w-[600px] h-[600px] bg-blue-500/10 rounded-full blur-3xl animate-float" />
        <div className="absolute bottom-0 right-1/4 w-[600px] h-[600px] bg-purple-500/10 rounded-full blur-3xl animate-float" style={{ animationDelay: '1s' }} />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-cyan-500/5 rounded-full blur-3xl animate-float" style={{ animationDelay: '2s' }} />
      </div>
      ...
      <div className="relative z-10">
          ...
          <div className="max-w-6xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-16">
              <button
                ...
                className="group relative px-10 py-5 bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 
                  text-white font-bold rounded-2xl text-lg transition-all duration-300 
                  shadow-2xl shadow-cyan-500/40 hover:shadow-cyan-500/60 hover:scale-105
              ...
              <button
                ...
                className="px-10 py-5 bg-gray-800/50 hover:bg-gray-800 border-2 border-gray-700 hover:border-cyan-500/50
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {features.map((feature, idx) => (
                <div 
                  key={idx}
                  className="group bg-gray-900 border border-gray-800 hover:border-cyan-500/50 rounded-2xl p-8 
                    transition-all duration-500 hover:shadow-2xl hover:shadow-cyan-500/10 hover:-translate-y-2
        ...
        <div className="py-20 px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <button
              onClick={() => navigate('/app')}
              className="group px-12 py-6 bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 
